...
import type { ScreenName, SeasonTuple, ScreenProps } from "../../types";
import { HeaderBar, ActionButtonsRow, Poster } from "../../components";
import { completionStatusToText } from "../../lib";


const screenName: ScreenName = "Show"
    ...
    <div className="screen--wrap show--wrap">
      ...
      <div className="show__main-screen--wrap">
        ...
        <div className="show__body">
          ...
          <ActionButtonsRow screenName={screenName} mediaCard={mediaCard} onGo={() => onGo(seasons)}/>
          ...
          <div className="meta-row--wrap">
            ...
            <span  className={`meta-row__item meta-row__item--completion-status-${determineCompletionStatusClassName()}`}>{completionStatusToText(mediaCard.completionStatus)}</span>
